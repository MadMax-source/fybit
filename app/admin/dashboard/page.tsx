    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Welcome back, monitor your platform performance</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Trading Volume</h2>
            <div className="h-64 flex items-end justify-around space-x-2">
              {[45, 62, 58, 71, 65, 78, 92].map((height, i) => (
                <div key={i} className="flex-1 flex flex-col items-center">
                  <div
                    className="w-full bg-emerald-600 rounded-t hover:bg-emerald-500 transition-colors"
                    style={{ height: `${height}%` }}
                  />
          ...
          <Card className="p-6">
            ...
            <div className="flex items-center justify-center h-64">
              <div className="relative w-48 h-48">
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                  ...
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#10b981" strokeWidth="20" strokeDasharray="188.4 62.8" />
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#3b82f6" strokeWidth="20" strokeDasharray="62.8 188.4" strokeDashoffset="-188.4" />
                </svg>
            ...
            <div className="flex justify-center space-x-6 mt-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">Verified (75%)</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-blue-600 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Pending (25%)</span>
              </div>
            </div>
          </Card>
        </div>
              ...
              <tbody>
                {recentActivities.map((activity, index) => (
                  <tr key={index} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <td className="py-3 px-4 text-sm text-gray-900 dark:text-white">{activity.user}</td>
                    <td className="py-3 px-4 text-sm text-gray-700 dark:text-gray-300">{activity.action}</td>
                    <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white">{activity.amount}</td>
                  </tr>
                ))}
              </tbody>
            </table>
